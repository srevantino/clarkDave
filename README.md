...
A-SYS_clark is a Windows utility for streamlined *installs*, *tweaks*, *config* fixes, and *updates*. It incorporates material derived from the open-source [Clark](https://github.com/ChrisTitusTech/clark) project; use of **this** distribution is **not** open source—see [LICENSE](LICENSE).
...
irm https://github.com/ChrisTitusTech/Clark/releases/latest/download/Clark.ps1 | iex
