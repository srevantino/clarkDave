function Invoke-Preprocessing {
    ...
    if ($ExcludedFiles.Count -gt 0) {
        ...
        ForEach ($excludedFile in $ExcludedFiles) {
            ...
            if (Test-Path -LiteralPath "$filePath") {
                ...
                $files = Get-ChildItem -Recurse -LiteralPath "$filePath" -File -Force -ErrorAction SilentlyContinue
    ...
    for ($i = 0; $i -lt $numOfFiles; $i++) {
        ...
        #   make more formatting rules, and document them in Clark Official Documentation
        ...
        Set-Content -LiteralPath $fullFileName -Value $fileContent
