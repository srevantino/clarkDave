...
function Initialize-WinUtilISODownloadTls {
    try {
...
function Invoke-WinUtilISOBitsOrHttpDownload {
    ...
    try {
        ...
        try {
            $client = New-WinUtilISODownloadHttpClient
