...
Clark provides three update modes so you can choose how aggressively Windows Update is managed on your system:
...
- **Notes**: This removes custom update settings previously applied by Clark. If update errors continue, use the reset option in the **Config** tab to restore Microsoft Update services to their default state.
